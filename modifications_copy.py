...
def create_checkboxes(criteria_list):
    ...
    for checkbox in range(len(criteria_list)):
        ...
        current_box = Checkbutton(frm_checkboxes, text=name, font="Arial,16", height=2, width=25, wraplength=200,
                                  bg="aqua", fg="blue", variable=current_var)  # current_box is the checkbutton object
